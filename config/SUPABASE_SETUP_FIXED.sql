-- ==========================================
-- PESA-AFRIK DATABASE SETUP - FIXED
...
DROP TABLE IF EXISTS ppp_data CASCADE;
...
-- Allow anyone to read profiles (needed for profile lookups)
